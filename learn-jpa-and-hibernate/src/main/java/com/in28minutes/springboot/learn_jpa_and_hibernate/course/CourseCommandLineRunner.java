...
//	private CourseJdbcRepository repository;
	...
	//	repository.save(new Course(1, "Learn AWS Jpa!", "in28minutes"));
		repository.save(new Course(1,"Learn GCP","in28minutes"));
		repository.save(new Course(2,"Learn AWS","in28minutes"));
		repository.save(new Course(3,"Learn Asure","in28minute"));
	...
	//	System.out.println(repository.findByName("Learn Asure!"));
